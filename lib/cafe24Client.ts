...
const SCOPES = "mall.read_order mall.write_order mall.write_shipping mall.read_product mall.write_product mall.read_category mall.write_category mall.read_analytics mall.read_community mall.write_community";
