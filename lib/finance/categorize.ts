...
const RULES: Rule[] = [
  ...
  // 최보경 = 사장님 배우자, 송금은 생활비(사장님 확인 2026-08-25).
  {
    ...
    patterns: [
      ...
      /디딤돌홍제우|디딤돌홍시우/,     // 자녀 적금 자동이체 (2026-08-28)
      /숙이네부뚜막|팔사진관|끌림|마카롱|업스포츠|크리에잇펀|온다윤/, // 가족 소비 (2026-08-28)
  ...
  // ⚠️ 나비스트 계좌는 국민은행 — 은행 표기가 "(주)나비스트" / "국민(주)나비스트" 둘 다 나온다.
  {
    ...
    patterns: [
      /조성섭/,
      /나비스트/,
      // ⚠️ 우리은행 오픈뱅킹은 상호를 잘라 적는다 — "토스 (주)나" = (주)나비스트
      //    (2026-05-18 1,727,000원 주얼리 매입, 사장님 확인 2026-08-28).
      //    뒤에 글자가 이어지면(=(주)나비스트·(주)나이키 등) 매칭 안 되게 경계를 둔다.
      /\(주\)\s*나(?![가-힣A-Za-z0-9])/,
      /드레안/,
    ],
  },
  ...
  // ── 미분류 정리 2026-08-28 ────────────────────────────
  // '기타' 2,684만(578건) 중 성격이 명확한 것들을 규칙화. 근거는 상대처명 자체.
  {
    category: "소프트웨어",
    patterns: [
      /카페24\s*주식회사|카페24주식회사/,   // 쇼핑몰 솔루션 이용료 (⚠️ 입금 '카페24페이먼'=정산과 구분)
    ],
  },
  {
    category: "수수료",
    patterns: [
      /NICE결제대행|나이스결제/i,            // PG 수수료
      /제이제이네트웍/,                      // 결제·부가서비스
    ],
  },
  {
  ...
  },
  {
    category: "교통/연료",
    patterns: [
      /에너지\(주\)|에스에이치에너|KH에너지|주유소|오일뱅크|GS칼텍스|현대오일|SK에너지/,
    ],
  },
  {
    category: "보험료",
    patterns: [
      /농협생명|삼성생명|한화생명|교보생명|메리츠화재|DB손해|현대해상|KB손해/,
    ],
  },
