...
const ALLOW_PREFIX = [
  ...
  "/api/print/",       // 윈도우 라벨 인쇄 에이전트(x-print-token, APP_AUTH_SECRET 파생) — 2026-09-15
  ...
  "/pv-notice.js",        // 상단 띠배너 스크립트 (두 몰 스킨에 주입, 공개 정적파일) — 2026-09-16
  "/pv-track-en.js",      // 영문몰 GA4+메타픽셀 계측 (카페24 스크립트태그로 주입, 공개 정적파일) — 2026-09-15
  "/hrt-engrave.js",      // 해리엇 설월 각인 미리보기 (카페24 스크립트태그로 주입, 공개 정적파일) — 2026-09-25
  "/hrt-pdp.js",          // 해리엇 상세페이지 데스크탑 수리 (내부스크롤 제거·sticky 칼럼) — 2026-09-26
  "/pv-engrave.js",       // 폴바이스 에끌라 오벌 각인 미리보기 (카페24 스크립트태그로 주입, 공개 정적파일) — 2026-09-26
  "/pv-pdp.js",           // 폴바이스 상세페이지 레이아웃 수리 (각인칸 폭·하단바 잘림) — 2026-09-26
