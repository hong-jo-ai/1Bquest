...
(function () {
  ...
  function injectStyles() {
    var css = ""
      ...
      + ".pv-chat-mark{position:relative;z-index:1;width:46px;height:46px;display:flex;align-items:center;justify-content:center;color:#fff}"
      + ".pv-chat-logo{width:40px;height:40px;display:block;filter:drop-shadow(0 1px 1px rgba(0,0,0,.16))}"
