...
import { OCCASIONS, getMoonData, formatKoreanDate, type MoonData, type PhaseKey, type Occasion } from "./moonShared";

const SHARE_ENDPOINT = "https://harriot-moon.vercel.app/moon/s";
...
const OCCASION_STORIES: Record<Occasion, string> = {
  ...
  travel: "떠나온 곳으로 돌아가기 전날의 밤은 유난히 천천히 흐릅니다. 여행은 끝나도, 그 밤에 올려다본 하늘은 오래도록 같은 자리에서 빛납니다.",
  longing: "보고 싶다는 마음은 거리를 계산하지 않습니다. 같은 달을 보고 있다는 사실 하나가, 그날 밤에는 작지 않은 위로가 되었을 것입니다.",
  flutter: "무언가 시작되기 전날의 마음은 쉽게 잠들지 못합니다. 그 밤의 달빛은 아직 오지 않은 내일을 미리 비추고 있었는지도 모릅니다.",
  waiting: "기다림은 아무것도 하지 않는 시간이 아닙니다. 달이 차오르는 것처럼, 보이지 않는 곳에서 무언가 조금씩 자라고 있던 밤이었습니다.",
  alone: "혼자라는 사실이 유난히 크게 느껴지는 밤이 있습니다. 하지만 그 밤에도 달은 떠 있었고, 당신은 그 밤을 지나 여기까지 왔습니다.",
  restart: "끝이라고 생각한 자리에서 다시 시작을 정하는 일은 쉽지 않습니다. 그 밤의 결심은 달처럼, 이지러진 뒤에 다시 차오르는 법을 알고 있었습니다.",
