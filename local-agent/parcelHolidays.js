...
const NO_PICKUP = new Set([
  ...
  "2026-09-24", // 추석 연휴 (9/24 목 ~ 9/26 토, 추석 당일 9/25 금)
  "2026-09-25", //   9/26(토)·27(일)은 주말이라 launchd Weekday 1~5 에서 이미 빠진다
  // ⚠️ 2026-09-28(월)을 다시 넣지 말 것 — **대체공휴일이 아니다.**
  //    추석 연휴가 일요일과 겹치지 않아 대체공휴일 요건 미충족이고, 임시공휴일 지정도 없다(2026-09-16 확인).
  //    택배기사 안내도 "24~27 휴무, 나머지는 정상 집하"로 일치한다.
  //    잘못 등록돼 있던 것을 뺐다 — 두면 **명절 직후 물량이 가장 몰리는 월요일 접수가 통째로 스킵**된다.
  //    (정부가 임시공휴일로 지정하면 그때 다시 넣을 것.)
